...
from Section09_Decorator.Practice.Circle import Circle
from Section09_Decorator.Practice.ColoredShape import ColoredShape
from Section09_Decorator.Practice.Square import Square
